...
if(isset($_POST['Email'])) {
    ...
    $email_to = "cv.senses@gmail.com";
    //$email_to = "info@charlotteverlinden.be";
     
    $email_subject = "website contactformulier";
...
//echo "U bericht is succesvol verzonden en we contacteren u zo spoedig mogelijk!";
